...
CATEGORY_KEYWORDS = {
    ...
    "محكمة_تجارية": ["محكمة تجارية", "دعوى تجارية", "منازعة تجارية", "تاجر", "عمل تجاري",
                      "أمر أداء", "أوامر الأداء", "حجز تحفظي", "حراسة قضائية", "تنفيذ معجل",
                      "استئناف تجاري", "نقض تجاري", "دعوى يسيرة", "دعوى جماعية",
                      "إفلاس", "شركات تجارية", "ملكية فكرية", "سجل تجاري",
                      "صحيفة الدعوى التجارية", "طلب مستعجل تجاري", "تبليغ تجاري",
                      "محاكم تجارية", "إشعار وفاء"],
    # ضوابط إجراءات الإثبات إلكترونياً
    "إثبات_إلكتروني": ["إثبات إلكتروني", "إجراءات الإثبات إلكترونياً", "نفاذ وطني",
                        "شهادة إلكترونية", "استجواب إلكتروني", "يمين إلكترونية",
                        "خبرة إلكترونية", "معاينة إلكترونية", "دليل إلكتروني",
                        "محرر إلكتروني", "ضوابط الإثبات"],
