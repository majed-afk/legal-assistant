...
export default function UsageLimitBanner({ action = 'questions' }: UsageLimitBannerProps) {
  ...
  if (!canPerform) {
    // Limit reached
    return (
      <div className="mx-4 mb-3 p-3 rounded-xl bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800/50 flex items-center justify-between gap-3 animate-fade-in">
  ...
  // Approaching limit
  return (
    <div className="mx-4 mb-3 p-3 rounded-xl bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800/50 flex items-center justify-between gap-3 animate-fade-in">
      <div className="flex items-center gap-2">
