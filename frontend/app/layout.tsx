...
export const metadata: Metadata = {
  ...
  description: 'مستشار قانوني ذكي متخصص في الأنظمة السعودية: الأحوال الشخصية والمعاملات المدنية والإثبات والمرافعات الشرعية. احصل على استشارات قانونية فورية مدعومة بالذكاء الاصطناعي.',
  ...
  twitter: {
    card: 'summary',
    title: 'سند — مستشارك القانوني الذكي',
    description: 'استشارات قانونية فورية مدعومة بالذكاء الاصطناعي — متخصص في 4 أنظمة سعودية',
